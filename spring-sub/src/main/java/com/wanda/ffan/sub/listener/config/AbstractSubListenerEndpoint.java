...
import com.wanda.ffan.sub.listener.adapter.FilteringMessageListenerAdapter;
 ...
 */
public abstract class AbstractSubListenerEndpoint implements SubListenerEndpoint, BeanFactoryAware, InitializingBean {
    ...
    protected RecordFilterStrategy getRecordFilterStrategy() {
        ...
        if (this.recordFilterStrategy != null) {
            if (messageListener instanceof AcknowledgingMessageListener) {
                messageListener = new FilteringAcknowledgingMessageListenerAdapter(
                        (AcknowledgingMessageListener) messageListener, this.recordFilterStrategy,
                        this.ackDiscarded);
            }
            else {
